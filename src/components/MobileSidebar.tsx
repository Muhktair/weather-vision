...
import { X, Wind, Droplets, Grid3X3, User, Users, BarChart3, Settings, Moon, Sun, Bell } from "lucide-react";
...
export const MobileSidebar = ({ isOpen, onClose, isDarkMode, onToggleTheme }: MobileSidebarProps) => {
            ...
            <div className="flex-1 px-4 overflow-hidden">
              <div className="flex items-center justify-between mb-4">
                ...
                <select 
                  value={unit}
                  onChange={(e) => setUnit(e.target.value as TemperatureUnit)}
                  className="text-xs bg-white/10 border border-white/20 rounded-md px-2 py-1 text-white"
                >
                  <option value="celsius" className="bg-gray-800">Celsius</option>
                  <option value="fahrenheit" className="bg-gray-800">Fahrenheit</option>
                </select>
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      {/* Sidebar */}
      <div className="absolute right-0 top-0 h-full w-80 sidebar-blue shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
        {/* Header */}
